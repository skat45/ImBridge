...
@Composable
fun DevicePanel(navController: NavHostController, deviceState: DeviceState) {
    var sliderPosition by remember { mutableFloatStateOf(deviceState.brightness.toFloat()) }
    var isDisplayOnSwitchChecked by remember { mutableStateOf(deviceState.is_on) }
